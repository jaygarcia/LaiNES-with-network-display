...
typedef BLARG_BOOST::int16_t blip_sample_t;
...
private:
	...
	public:
		...
		typedef BLARG_BOOST::uint16_t buf_t_;
...
typedef BLARG_BOOST::uint32_t blip_pair_t_;

class Blip_Impulse_ {
	typedef BLARG_BOOST::uint16_t imp_t;
